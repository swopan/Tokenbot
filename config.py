...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002111593925"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1707772962,1709824863").split()):
        ADMINS.append(int(x))
except ValueError:
