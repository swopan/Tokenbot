...
#Database 
DB_URI = "mongodb+srv://sunitverma08: dbusersumit@cluster0.qxdsclm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6931135453,1709824863,5857939104").split()):
        ADMINS.append(int(x))
except ValueError:
